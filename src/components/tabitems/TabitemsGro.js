...
function TabitemsGro({ onRequestClose, onAddNewDiv }) {
...
<div className='space'></div>
      ...
      <div className="new-content" onClick={() => onAddNewDiv()}>
        ...
        <div className="new-content1">Cat Label Cat Label</div>
        <div className="new-content">Nothing Cat Label</div>
        <div className="new-content1">P24 Cat Label</div>
          <div className="new-content" onClick={() => (alert("Sure to Cancel-2"))}><p>Cat Label2</p></div>
        <div className="new-content1">Cat Label Nothing</div>
        <div className="new-content">Nothing Nothing</div>
        <div className="new-content1">Nothing P24</div><br/>
